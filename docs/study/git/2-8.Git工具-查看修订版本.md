---
prev: ./2-7.Git分支-变基.md
next: ./2-9.Git工具-交互式暂存.md
---
...
<a data-fancybox title="Example history for range selection." href="/img/git/double-dot.png">![Example history for range selection.](/img/git/double-dot.png)</a>
